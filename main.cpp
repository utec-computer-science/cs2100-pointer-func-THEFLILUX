...
void  _b_double_ (void * _vector_, int _i,int _k){
    if (((double*)_vector_)[_i] > ((double*)_vector_)[_i+1]){
        _k = ((double*)_vector_)[_i];
        ((double *)_vector_)[_i] = ((double *)_vector_)[_i+1];
        ((double*)_vector_)[_i+1] = (double) _k;
    }
}
